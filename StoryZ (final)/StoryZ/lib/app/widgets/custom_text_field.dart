  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: (widget.height == null)
          ? 19.0 * SizeConfig.blockWidth
          : widget.height,
      child: Container(
        margin: EdgeInsets.symmetric(vertical: 2.0 * SizeConfig.blockWidth),
        padding: EdgeInsets.symmetric(horizontal: 4.0 * SizeConfig.blockWidth),
        ...
        child: Container(
          ...
          child: TextFormField(
            ...
            enableInteractiveSelection:
                widget.visibility != true ? true : false,
            textAlignVertical: widget.useSuffixIcon!
